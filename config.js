module.exports = {
	...
	adminId: "749966923814666320", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "ODkyNjI5MDc4MTI4MDk1MjMy.GHH-LE.yUzg_ah8_D4ac5k9lNl2AkR8YQJEr7zd4yUrsM", //- Bot's Token
	clientId: process.env.clientId || "892629078128095232", //- ID of the bot
	clientSecret: process.env.clientSecret || "wxCjfJCE8I-glftDWiMgw-QRWNadTtTP", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lavalink.fortila.repl.co", //- The host name or IP of the lavalink server.
			port: 443, // The port that lavalink is listening to. This must be a number!
			password: "alifortilabot", //- The password of the lavalink server.
			retryAmount: 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, //- The amount of times to retry connecting to the node if connection got dropped.
